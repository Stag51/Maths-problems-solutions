...
#     <p class="logo-text" style="color: white;">Equation Solver using CNN</p>
#     </div>
#     """,
#     unsafe_allow_html=True
# )
...
#     st.markdown("<p style='text-align: center; font-size: 1.2em; color: white;'><a href='https://github.com/Mujeeb117'>Explore my Codes</a></p>", unsafe_allow_html=True)
#     st.markdown("<p style='text-align: center; font-size: 1.2em; color: white;'><a href='https://www.linkedin.com/in/mujeeb-ur-rehman-b91378202/'>Connect with me on LinkedIn</a></p>", unsafe_allow_html=True)
# data = st_canvas(
